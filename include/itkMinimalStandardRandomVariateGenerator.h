...
#include "StructurePreservingColorNormalizationExport.h"
 ...
 */
class StructurePreservingColorNormalization_EXPORT MinimalStandardRandomVariateGenerator : public RandomVariateGeneratorBase
{
public:
